...
def compute_rewrite_quality_counterfact(
    ...
    if snips is not None and enable_text_generation:
    ...
    elif snips is not None and not enable_text_generation:
        # Skip text generation but add empty generation stats for consistency
        ret.update({
            "ngram_entropy": 0.0,
            "reference_score": 0.0,
            "text": [],
